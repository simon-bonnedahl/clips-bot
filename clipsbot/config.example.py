...
DATA = ["g Illuvium"]
BLACKLIST = []  # channels/games you dont want to be included in the video
...
INTRO_FILE_PATH = PATH + "/clipsbot/files/intro.mp4"  # Path to video file (str)
ENABLE_TRANSITION = True
RESIZE_TRANSITION = True
TRANSITION_FILE_PATH = PATH + "/clipsbot/files/transition.mp4"
ENABLE_OUTRO = False
RESIZE_OUTRO = True
OUTRO_FILE_PATH = PATH + "/clipsbot/files/outro.mp4"
